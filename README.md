...
The objective of this project is to analyze a comprehensive dataset of Brazilian oil wells to evaluate production strategies and asset health. The focus is on understanding the performance across different Plays (e.g., Bakken, Montney, Duvernay) and Resource Types (Conventional vs. Tight) to optimize resource management and operational efficiency.  



<h2>2. Business Assumptions</h2>
The analysis is based on the Brazilian_Oil_Wells_Enhanced.xlsx dataset. While based on regional well data, specific production volumes and downtime events were modeled to demonstrate end-to-end analytical capabilities suitable for Data Analyst role.  



<h2>3. Solution Strategy</h2>
<h4>3.1 Data Acquisition</h4>
Loaded well master data from Brazilian_Oil_Wells_Enhanced.xlsx, encompassing dimensions such as UWI, Operator, Field and Play.
...
UWI Standardization: Ensured Unique Well Identifiers (UWI) follow the Brazilian regulatory format for precise table joining.
...
<h4>3.4 Dimensional Modeling (Star Schema)</h4>
...
<h4>4.1 Which exhibits the highest density of active completions?</h4>
The analysis identifies the plays as the primary drivers of recent activity, with a significant concentration of horizontal wells compared to vertical completions.
